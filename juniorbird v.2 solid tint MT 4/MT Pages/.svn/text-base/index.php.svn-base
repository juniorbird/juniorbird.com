	...
	<body>
		...
		<div id="content">
			...
			<div id="diary">
				...
				<div class="googlead">
					...
					google_ad_client = "pub-1168697838932805";
					google_ad_width = 468;
					google_ad_height = 60;
					...
					google_color_link = "CEFFF3";
					google_color_text = "FFFFFF";
					google_color_url = "CCAA22";
					//--></script>
					<script type="text/javascript"
		...
		<div id="footer">
			...
			<div id="archives">
				...
				<p>Diary and blog: <a href="archives.php">Archives</a></p>
				<p>Moblog: <a href="/foto/fotoarchive.php">Photos</a></p>
